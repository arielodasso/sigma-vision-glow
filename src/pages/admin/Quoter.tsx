...
import { Calculator, Plus, X, Copy, FileText } from "lucide-react";
...
type Region = "ar" | "latam" | "us";

const REGIONS: Record<Region, { label: string; factor: number }> = {
    ...
    <div className="space-y-8">
      ...
      <section className="bg-card border border-foreground/[0.06] rounded-2xl p-5 space-y-4">
        ...
        <p className="text-xs text-foreground/40">
          Tarifa Dev final estimada: <span className="text-foreground/70 font-medium">{usd(effectiveDevRate)}/hs</span>
        </p>
      </section>
      ...
      <section className="bg-card border border-foreground/[0.06] rounded-2xl p-5 space-y-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button type="button" onClick={toBudget}
            ...
            <FileText size={15} /> Convertir en presupuesto formal
          </button>
        </div>
      </section>
    </div>
