          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-display text-lg sm:text-2xl font-semibold text-foreground">{categories.web.title}</h3>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-display text-lg sm:text-2xl font-semibold text-foreground">{categories.platforms.title}</h3>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-display text-lg sm:text-2xl font-semibold text-foreground">{categories.automation.title}</h3>
              </div>
