...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      />
      {/* Radial gradient blobs — grays only */}
      ...
      <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl pt-24">
        <div className="inline-block glass rounded-full px-4 py-1.5 mb-8 text-xs font-medium text-secondary-soft tracking-wide">
        ...
        <p className="text-lg sm:text-xl text-secondary-soft max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#productos"
            className="flex items-center gap-2 btn-primary-neutral px-8 py-3.5 rounded-full text-sm"
          >
            Ver productos
            <ArrowRight size={16} />
          </a>
          <a
            href="#contacto"
            className="flex items-center gap-2 btn-glass-outline px-8 py-3.5 rounded-full text-sm"
          >
